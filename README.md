...
- A visual page comparison with changed pixels highlighted.
...
- Visual comparison renders the selected page and highlights changed regions. This catches layout/image changes that text extraction may miss.
